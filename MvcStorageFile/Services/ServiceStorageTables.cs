...
namespace MvcStorage.Services
{
    public class ServiceStorageTables
    {
        ...
        public async Task CreateClientAsync(String idcliente
            , String nombre, String edad, String empresa)
        {
        ...
        {
            TableQuery<Cliente> query =
                new TableQuery<Cliente>();
            TableQuerySegment<Cliente> segment =
                await this.table.ExecuteQuerySegmentedAsync(query, null);
